package hiveworkshop.blizzard.casc;

import hiveworkshop.lang.Hex;
...
public final class Key implements Comparable<Key> {
    ...
    byte[] f1 = new byte[commonLength];
    byte[] f2 = new byte[commonLength];

    System.arraycopy(key, 0, f1, 0, f1.length);
    System.arraycopy(o.key, 0, f2, 0, f2.length);
	...
	public boolean equals(final Object obj) {
		...
		byte[] f1 = new byte[commonLength];
    byte[] f2 = new byte[commonLength];
    System.arraycopy(key, 0, f1, 0, commonLength);
    System.arraycopy(otherKey.key, 0, f2, 0, commonLength);
